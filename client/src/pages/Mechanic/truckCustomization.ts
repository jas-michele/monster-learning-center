import blackTruck from '../../assets/mechanic/blackTruck.png'
import blueTruck from '../../assets/mechanic/blueTruck.png'
import greenTruck from '../../assets/mechanic/greenTruck.png'
import purpleTruck from '../../assets/mechanic/purpleTruck.png'
import redTruck from '../../assets/mechanic/redTruck.png'

export type TruckColor = 'red' | 'green' | 'blue' | 'purple' | 'black'
